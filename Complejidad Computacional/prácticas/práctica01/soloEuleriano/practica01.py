...
class AnalisisGrafo:
    ...
    # existencia de caminos eulerianos y sus detalles.
    @staticmethod
...
def ejecutar(archivo_entrada, archivo_salida):
    try:
        ...
        euleriano, detalle_euler = AnalisisGrafo.mostrar_info_grafo(grafo)
        
        # Dibujar el grafo y resaltar los caminos si existen.
        dibujar_grafo(grafo, detalle_euler)
